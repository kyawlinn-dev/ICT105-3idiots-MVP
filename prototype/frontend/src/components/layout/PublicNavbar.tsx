  ...
  return (
    <>
      <header className="sticky top-0 z-40 border-b border-slate-200/80 bg-white/95 shadow-[0_1px_8px_rgba(15,23,42,0.04)] backdrop-blur">
        <div className="mx-auto hidden h-16 max-w-7xl items-center justify-between gap-4 px-6 lg:flex lg:px-8">
            ...
            {visibleNavItems.map((item) => (
              <NavLink
                ...
                className={({ isActive }) => cn(
                  "rounded-xl px-3 py-2 text-sm font-semibold text-slate-600 transition hover:bg-blue-50 hover:text-blue-700 xl:px-3.5 xl:text-[15px]",
