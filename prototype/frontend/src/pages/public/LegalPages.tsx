...
export function PrivacyPolicyPage() {
  return <LegalPage title="Privacy Policy" introduction="This policy explains how Student Apartment Finder handles information when students, landlords, and administrators use the platform." sections={[
    { heading: "Information we collect", body: "We may collect account information such as your name, email address, phone number and LINE ID; apartment or roommate-post information; saved listings; messages; uploaded images; approximate property locations; and technical information needed to operate and secure the service." },
    { heading: "How information is used", body: "Information is used to authenticate accounts, display approved listings, provide saved items and private messaging, moderate submissions, send approval or rejection notifications, prevent misuse, and improve the service." },
    { heading: "Visibility and sharing", body: "Approved apartment and roommate-post details may be visible to platform users. Private messages are intended only for conversation participants. We do not ask users to share passwords, OTP codes, banking credentials, passport details, national ID numbers, or identity-document images in messages." },
...
export function TermsPage() {
  return <LegalPage title="Terms of Use" introduction="By creating an account or using Student Apartment Finder, you agree to use the platform responsibly and follow these terms." sections={[
    { heading: "Purpose of the platform", body: "Student Apartment Finder helps users discover student housing, publish roommate posts, save options, and communicate. The platform does not own, inspect, rent, or guarantee listed properties and is not a party to rental agreements." },
