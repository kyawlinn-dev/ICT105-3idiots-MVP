    ...
    <main className="bg-white">
      <section className="border-b border-slate-100 bg-gradient-to-b from-blue-50/70 to-white">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-8 sm:px-6 md:py-10 lg:grid-cols-[1.02fr_0.98fr] lg:px-8 lg:py-12 xl:py-14">
          <div className="flex flex-col justify-center">
            ...
            <h1 className="mt-4 max-w-3xl text-3xl font-bold leading-tight tracking-tight text-slate-950 min-[420px]:text-4xl lg:text-5xl xl:text-[3.35rem]">
            ...
            <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600 lg:text-lg">
              Compare verified owner listings by university, area, price, distance, facilities, photos, and map location.
            </p>
            <div className="mt-6 flex max-w-2xl flex-col gap-3 rounded-xl border border-slate-200 bg-white p-2 shadow-lg shadow-blue-100/60 sm:flex-row">
      ...
      <section className="border-y border-slate-100 bg-slate-50" id="about">
        <div className="mx-auto grid max-w-7xl gap-5 px-4 py-9 sm:px-6 md:grid-cols-3 lg:px-8">
          {[
            ...
            { title: "Clear contact flow", text: "Shortlist rooms and contact owners from approved listing pages.", icon: MessageCircle },
          ].map((feature) => (
      ...
      <section className="mx-auto max-w-7xl px-4 py-9 sm:px-6 lg:px-8">
        ...
        {featured.length ? (
          ...
          <EmptyState title="No approved apartments yet" description="After owners submit real listings and admin approves them, they will appear here." />
        )}
      </section>
      ...
      <section className="bg-blue-600 text-white">
        <div className="mx-auto grid max-w-7xl gap-6 px-4 py-9 sm:px-6 md:grid-cols-3 lg:px-8">
          {[
            ...
            ["Save or contact", "Shortlist approved rooms and contact the owner."],
          ].map(([step, text], index) => (
            <div key={step}>
