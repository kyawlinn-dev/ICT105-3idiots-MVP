...
export function OwnerDashboardPage({ listings, loading }: OwnerDashboardPageProps) {
  ...
  if (loading) {
    return <LoadingState label="Loading landlord dashboard…" />
  }
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <p className="text-xs font-bold uppercase tracking-wide text-blue-600">Landlord overview</p>
      ...
      <div className="grid gap-3 md:grid-cols-4">
        ...
        <MetricCard label="Avg. Rent" value={ownerListings.length ? formatCurrency(averageRent) : "—"} change="Per month" type="neutral" icon={LineChart} />
      </div>

      <Card>
        <CardHeader className="flex flex-row items-center justify-between p-4">
          <CardTitle className="text-base">Recent landlord listings</CardTitle>
