...
| **FR-03** | **User input or data submission feature**              | The system must allow apartment owners to submit and update apartment listing information such as apartment name, price, distance from campus, room type, facilities, availability, photos, map location, and contact details.                                  |
...
The web app prototype will allow users to click, submit and edit apartment listing data, view apartment records, search/filter listings, open apartment details, update listing status, and view an admin analytics dashboard.
