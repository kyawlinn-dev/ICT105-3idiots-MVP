...
Students searching for off-campus housing near campus find the process slow and confusing. Listings are scattered across Facebook groups, agents, and word of mouth, with unclear prices, room types, and distances. New and international students struggle most. Owners cannot reach students directly, and students who want to share costs cannot easily find a roommate.
...
The MVP should put scattered listings in one searchable place with clear price and distance, let owners post directly, and include a simple roommate-request board. Focus the first version on new and international students, who feel the pain most.
